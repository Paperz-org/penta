...
def get_path_param_pattern(item_id: str = Path(..., pattern="^foo")):
    return item_id


@router.get("/path/param-django-str/{str:item_id}")
def get_path_param_django_str(item_id):
    return item_id


@router.get("/path/param-django-int/{int:item_id}")
def get_path_param_django_int(item_id: int):
    assert isinstance(item_id, int)
    return item_id


@router.get("/path/param-django-int/not-an-int")
def get_path_param_django_not_an_int():
...
def get_path_param_django_uuid_typestr(item_id: str):
    assert isinstance(item_id, str)
    return item_id


@router.get("/path/param-django-path/{path:item_id}/after")
def get_path_param_django_path(item_id):
    return item_id
...
def get_query_list(query: List[str] = Query(...)):
    return ",".join(query)


@router.get("/query/list-optional")
def get_query_optional_list(query: Optional[List[str]] = Query(None)):
    if query:
        return ",".join(query)
    return query
...
def get_query_aliased_name(query: AliasedSchema = Query(...)):
...
def get_path_param_django_custom_int(item_id: int):
    return item_id


@router.get("/path/param-django-custom-float/{custom-float:item_id}")
def get_path_param_django_custom_float(item_id: float):
    return item_id
