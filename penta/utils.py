...
def contribute_operation_callback(
    ...
    if not hasattr(func, "_penta_contribute_to_operation"):
        func._penta_contribute_to_operation = []  # type: ignore
    func._penta_contribute_to_operation.append(callback)  # type: ignore


def contribute_operation_args(
    func: Callable[..., Any], arg_name: str, arg_type: Type, arg_source: Any
) -> None:
    if not hasattr(func, "_penta_contribute_args"):
        func._penta_contribute_args = []  # type: ignore
    func._penta_contribute_args.append((arg_name, arg_type, arg_source))  # type: ignore
